...
PATCHES_DIR = f'../mcv/datasets/Patches_P{PATCH_SIZE}_B{BATCH_SIZE}_E{EPOCHS}'
MODEL_FNAME = f'../mcv/datasets/models/patches{PATCH_SIZE}_batches{BATCH_SIZE}_epochs{EPOCHS}.h5'
...
if not os.path.exists(MODEL_FNAME):
  ...
  model.fit_generator(
          ...
          validation_steps= (807 * MAX_PATCHES) // BATCH_SIZE) # use correct number of images 807 * patches_per_image
