...
version='imgsize64_batchsize64_5layers_1024_512_128_512_50_epoch'
IMG_SIZE    = 64 #deafult 32
BATCH_SIZE  = 64 #default 16
DATASET_DIR = '/home/mcv/datasets/MIT_split'
MODEL_FNAME = f'/home/group02/working/output_results/my_first_mlp_{version}.h5'
...
#model.add(Dense(units=512, activation='relu', name='5'))
...
print(model.summary())
plot_model(model, to_file=f'../output_results/modelMLP_{version}.png', show_shapes=True, show_layer_names=True)
...
plt.savefig(f'../output_results/accuracy_{version}.jpg')
plt.close()
...
plt.xlabel('epoch')
plt.legend(['train', 'validation'], loc='upper left')
plt.savefig(f'../output_results/loss_{version}.jpg')
